    ...
    public static void main(String[] args) {
        ...
        switch (sx){
            case "m":
                ...
                System.out.printf("Máte %.2f \u2030 promile, úplnì vystřízlivíte za %.1f hodin",promM,vysledekM);                
                break;
            case "z":
                double vysledekZ = mET/uETz;
                System.out.printf("Máte %.2f \u2030 promile, úplnì vystřízlivíte za %.1f hodin",promZ,vysledekZ);                
                break;
        }
