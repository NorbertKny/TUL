...
public class P13Alkohol {
    ...
    public static void main(String[] args) {
        ...
        switch (sx){
            case "m":
                double vysledekM = promM/uETm;
                System.out.println("Máte" +promM+ "promile, odourani"+vysledekM);
                break;
            case "z":
                double vysledekZ = promZ/uETz;
                System.out.println("Máte" +promZ+ "promile, odbourabi"+vysledekZ);
                break;
        }
